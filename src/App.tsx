...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0f1115] text-white selection:bg-[#22c55e]/30">
        ...
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="rounded-full bg-[#22c55e] px-5 py-2 text-sm font-bold text-black hover:bg-[#4ade80] transition-colors"
            >
              Pišite nam
            </button>
            <button
      ...
      <section ref={containerRef} className="relative h-[250vh] w-full">
        ...
        <div className="sticky top-16 flex h-[calc(100vh-4rem)] w-full items-center justify-center overflow-hidden">
          ...
          {/* Background Glows */}
          <div className="absolute left-1/2 top-1/2 -z-10 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#22c55e]/10 blur-[120px]" />
          ...
          <div className="scale-[0.7] sm:scale-[0.85] md:scale-100 flex items-center justify-center">
            ...
            <div 
              ref={phoneRef}
              className="relative h-[720px] w-[350px] rounded-[55px] border-[12px] border-[#1a1a1a] bg-[#0f1115] shadow-[0_0_0_2px_#2a2a2a,0_40px_100px_-20px_rgba(0,0,0,0.8)]"
            >
            {/* Dynamic Island */}
            ...
            <div className="absolute inset-0 overflow-hidden rounded-[43px] bg-[#0e1621]">
              ...
              <div className="absolute left-0 top-0 z-40 flex w-full items-center gap-3 bg-[#17212b]/95 px-5 pb-3 pt-14 backdrop-blur-md">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#22c55e] text-[14px] font-bold text-white">
                  OR
                </div>
                <div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-12 md:grid-cols-3">
            <div className="group relative">
              <span className="font-mono text-8xl font-black text-white/5 transition-colors group-hover:text-[#22c55e]/10">01</span>
              <div className="absolute top-12 left-0">
                <h3 className="mb-3 text-xl font-bold">Povejte, kaj iščete</h3>
                <p className="text-gray-400">
                  Sporočite nam portal, ključne besede, lokacijo in cenovni razpon. Primer: <span className="italic text-[#22c55e]/80">"Woom kolo na Bolhi pod 250 €."</span>
                </p>
              </div>
            </div>
            <div className="group relative">
              <span className="font-mono text-8xl font-black text-white/5 transition-colors group-hover:text-[#22c55e]/10">02</span>
              <div className="absolute top-12 left-0">
            ...
            <div className="group relative">
              <span className="font-mono text-8xl font-black text-white/5 transition-colors group-hover:text-[#22c55e]/10">03</span>
              <div className="absolute top-12 left-0">
      ...
      <section className="py-24 px-6">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <div>
              <h2 className="mb-2 text-[#22c55e] font-bold uppercase tracking-wider">Telegram obvestila</h2>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6 md:gap-6">
            {[
              ...
              <div
                key={portal.name}
                className="gradient-border group relative flex flex-col rounded-2xl bg-[#151619] p-5 transition-all duration-300 hover:bg-white/5 hover:-translate-y-1 overflow-hidden"
              >
          ...
          <p className="mt-16 text-center text-gray-500">
            Iščete na drugem portalu? <span className="text-[#22c55e] font-medium">Pišite nam</span> — sistem je razširljiv.
          </p>
        </div>
      </section>
      ...
      <section id="preizkus" className="bg-[#0f1115] py-24 px-6">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="flex justify-center">
            <div className="gradient-border animated-border flex w-full max-w-sm flex-col rounded-3xl bg-[#151619] p-8 transition-all duration-300 hover:-translate-y-2 hover:scale-[1.02] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)]">
              ...
              <button 
                ...
                className="mt-auto w-full rounded-xl bg-[#22c55e] py-3 font-bold text-white transition-transform hover:scale-[1.02] active:scale-[0.98]"
              >
      ...
      <section id="cenik" className="bg-[#0f1115] py-24 px-6">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {/* Card 1: Začetnik */}
            <div className="gradient-border animated-border flex flex-col rounded-3xl bg-[#151619] p-8 transition-all duration-300 hover:-translate-y-2 hover:scale-[1.02] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)]">
              ...
              <a href="https://buy.stripe.com/test_7sYeVe7uJ3Yk89I7j6gQE00" target="_blank" rel="noopener noreferrer" className="mt-auto block w-full rounded-xl bg-white/5 py-3 text-center font-bold text-white ring-1 ring-white/10 transition-all hover:scale-105 hover:bg-[#22c55e]/20 hover:text-[#4ade80] hover:ring-[#22c55e]/40 active:scale-95">
                Izberi paket
              </a>
            </div>
            ...
            <div className="gradient-border animated-border flex flex-col rounded-3xl bg-[#151619] p-8 transition-all duration-300 hover:-translate-y-2 hover:scale-[1.02] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)]">
              ...
              <a href="https://buy.stripe.com/test_cNi14oaGV0M861AbzmgQE01" target="_blank" rel="noopener noreferrer" className="mt-auto block w-full rounded-xl bg-white/5 py-3 text-center font-bold text-white ring-1 ring-white/10 transition-all hover:scale-105 hover:bg-[#22c55e]/20 hover:text-[#4ade80] hover:ring-[#22c55e]/40 active:scale-95">
                Izberi paket
              </a>
            </div>

            {/* Card 3: Pro (Highlighted) */}
            <div className="gradient-border animated-border relative flex flex-col rounded-3xl bg-[#151619] p-8 shadow-[0_0_30px_-10px_rgba(74,222,128,0.3)] transition-all duration-300 hover:-translate-y-2 hover:scale-[1.02] hover:shadow-[0_20px_40px_-15px_rgba(74,222,128,0.4)] [&::before]:bg-gradient-to-br [&::before]:from-[#22c55e]/60 [&::before]:via-[#22c55e]/20 [&::before]:to-[#22c55e]/40">
            ...
            <div className="gradient-border animated-border flex flex-col rounded-3xl bg-[#151619] p-8 transition-all duration-300 hover:-translate-y-2 hover:scale-[1.02] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)]">
              ...
              <a href="https://buy.stripe.com/test_14A5kE2ap3Yk0HgdHugQE03" target="_blank" rel="noopener noreferrer" className="mt-auto block w-full rounded-xl bg-white/5 py-3 text-center font-bold text-white ring-1 ring-white/10 transition-all hover:scale-105 hover:bg-[#22c55e]/20 hover:text-[#4ade80] hover:ring-[#22c55e]/40 active:scale-95">
                Izberi paket
              </a>
            </div>
          </div>
  ...
  Odgovorimo še isti dan!
          ...
          <button 
            onClick={() => setIsModalOpen(true)}
            className="group inline-flex items-center gap-2 rounded-full bg-[#22c55e] px-10 py-4 text-lg font-bold text-black transition-all hover:scale-105 hover:shadow-[0_0_30px_-5px_rgba(74,222,128,0.5)] active:scale-95"
          >
              ...
              >
                {formStatus === 'success' ? (
                  <motion.div 
                    ...
                    className="rounded-xl bg-[#22c55e]/10 p-6 text-center text-[#22c55e] ring-1 ring-[#22c55e]/20"
                  >
                  ...
                  <>
                    <div>
                      ...
                      <input 
                        ...
                        type="text" 
                        required
                        className="w-full rounded-xl bg-white/5 p-4 text-white ring-1 ring-white/10 transition-all focus:bg-white/10 focus:outline-none focus:ring-2 focus:ring-[#22c55e]"
                    ...
                    <div>
                      ...
                      <textarea 
                        ...
                        required
                        rows={4}
                        className="w-full resize-none rounded-xl bg-white/5 p-4 text-white ring-1 ring-white/10 transition-all focus:bg-white/10 focus:outline-none focus:ring-2 focus:ring-[#22c55e]"
                    ...
                    <button 
                      ...
                      className="w-full rounded-xl bg-[#22c55e] py-4 font-bold text-black transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                  ...
                  <>
                    <div>
                      ...
                      <input 
                        ...
                        type="text" 
                        required
                        className="w-full rounded-xl bg-white/5 p-3.5 text-white ring-1 ring-white/10 transition-all focus:bg-white/10 focus:outline-none focus:ring-2 focus:ring-[#22c55e]"
                        ...
                        {['Bolha', 'Nepremičnine.net', 'Avto.net', 'Willhaben'].map((portal) => (
                          <label key={portal} className="flex items-center gap-2 cursor-pointer group">
                            <input 
                              ...
                              name="portals" 
                              value={portal} 
                              className="h-5 w-5 rounded border-white/10 bg-white/5 text-[#22c55e] focus:ring-[#22c55e] focus:ring-offset-0"
                            />
            ...
            <div className="bg-[#1e1e1e] ring-1 ring-white/10 rounded-2xl p-5 shadow-2xl flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div className="flex gap-3 shrink-0">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm rounded-xl bg-[#22c55e] hover:bg-[#4ade80] text-black font-semibold transition-colors"
                >
                  Sprejmi
                </button>
              </div>
